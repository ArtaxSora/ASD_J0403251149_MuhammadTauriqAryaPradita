...
print ("========= Program Kombinasi Biner dengan Batas '1' (Pruning) =========")
n = int(input("Masukkan nilai n (jumlah digit biner) : "))
batas = int(input("Masukkan batas jumlah '1' : "))
print(f"Kombinasi biner dengan {n} digit dan maksimal {batas} '1' adalah :")
biner_batas(n, batas)